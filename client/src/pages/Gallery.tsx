  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <motion.section
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(30, 58, 95, 0.3), rgba(15, 165, 95, 0.3)), url('https://images.unsplash.com/photo-1758101755915-462eddc23f57?q=80&w=1074&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')`,
      ...
      >
        <div className="container mx-auto px-4 text-center max-w-2xl">
          ...
          >
            ...
            <p className="text-gray-600 text-lg mb-8">We're curating our best project photos. Check back soon!</p>

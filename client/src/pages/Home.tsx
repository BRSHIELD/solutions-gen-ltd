      ...
      >
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 max-w-7xl mx-auto">
            {[
              "/manus-storage/Coop-Bank1_86863b83.jpg",
              "/manus-storage/KTRH-Logo-150x150_3a8af9fa.jpg",
              "/manus-storage/NSSF_288cec88.jpg",
              "/manus-storage/Windsor Club_a07c15bd.jpg",
              "/manus-storage/world-vision-vector-logo_1dca677f.jpg",
              "/manus-storage/Cytonn_8663d970.png",
              "/manus-storage/Equity_Bank_Logo_f739aa93.png",
              "/manus-storage/KCB Group_78875576.png",
              "/manus-storage/Muthaiga country club_0c893bc5.png",
              "/manus-storage/Tangaza-University-College_58e219c9.png",
              "/manus-storage/Transglobal_be218fe4.png",
              "/manus-storage/Turkana basin institute_a0c2a554.png",
              "/manus-storage/co-operative-bank-of-kenya-logo-png_seeklogo-172668_db3857d8.png",
              "/manus-storage/united-nations-logo-png_seeklogo-247981_fc2488ee.png",
              "/manus-storage/British High commission_a88c6cc0.jfif",
              "/manus-storage/Junction mall_84fc3f1d.jfif",
              "/manus-storage/Nairobi west_02369a1a.jfif",
              "/manus-storage/Tatu city_8a25fa8e.jfif",
              "/manus-storage/World bank logo_884d730d.jfif",
              "/manus-storage/coast_general_7b1bc96e.webp",
            ].map((logo, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, scale: 0.8 }}

  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <motion.section
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(30, 58, 95, 0.75), rgba(15, 165, 95, 0.75)), url('https://images.unsplash.com/photo-1610028290816-5d937a395a49?q=80&w=1171&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')`,

  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <motion.section
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(30, 58, 95, 0.6), rgba(15, 165, 95, 0.6)), url('https://images.unsplash.com/photo-1509390144018-eeaf65052242?q=80&w=1074&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')`,
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-700 text-lg mb-4">
                Solutions General Ltd was founded in 1996 by Eng. Patrick K. Nduva, a seasoned Electrical Engineer and visionary entrepreneur. From inception, we have been dedicated to delivering high-quality services, innovative solutions, and sustainable growth across East Africa.
              </p>
              <p className="text-gray-700 text-lg mb-4">
